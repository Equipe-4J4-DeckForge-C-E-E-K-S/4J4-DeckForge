Shader "Hidden/Locked/.poiyomi/Poiyomi Pro/3f0cf2a6a4ff03840bc8fab7cea8614c"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void calculateShading(inout PoiLight poiLight, inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiCam poiCam)
			{
				...
				#endif
				float shadowStrength = (0.65 /*_ShadowStrength*/) * poiLight.shadowMask;
				#ifdef POI_PASS_OUTLINE
			...
			{
				float smoothness = (0.548 /*_MochieRoughnessMultiplier*/);
