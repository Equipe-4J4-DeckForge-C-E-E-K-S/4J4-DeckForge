Shader "Hidden/Locked/.poiyomi/Old Versions/8.2/Poiyomi Pro/1518c6cddcbbc1b45ba050f62ccc5209"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void applyDecals(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiCam poiCam, inout PoiMods poiMods, in PoiLight poiLight)
			{
				...
				Decal0.m_DecalPosition = float4(0.19,0.73,0,0);
				Decal0.m_DecalRotationSpeed = (5.0 /*_DecalRotationSpeed*/);
				...
				Decal0.m_DecalHueShiftSpeed = (1.0 /*_DecalHueShiftSpeed*/);
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				#endif
				poiFragData.baseColor = mainTexture.rgb * poiThemeColor(poiMods, float4(0.001925761,0.637597,0,1).rgb, (0.0 /*_ColorThemeIndex*/));
				poiFragData.alpha = mainTexture.a * float4(0.001925761,0.637597,0,1).a;
