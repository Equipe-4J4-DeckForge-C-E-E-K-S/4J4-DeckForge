Shader "Hidden/Locked/.poiyomi/Old Versions/8.0/Poiyomi Toon/96b167486916ff5468ea4ea71237fa77"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			v2f vert(appdata v)
			{
				...
				if((1.0 /*_UDIMDiscardMode*/) == 0) // Discard Vertices instead of just pixels
				{
					float2 udim = 0;
			...
			{
				if((1.0 /*_UDIMDiscardMode*/) == 1) // Don't run if in vertex mode
				{
